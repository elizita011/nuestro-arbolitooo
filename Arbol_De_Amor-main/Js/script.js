...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para kevshup:\n\nYa pasó tu pumpe pero no importa, te amo muchín peladito.\n\nY a su vez, ya tenemos nuestro primer aniversario de amistad, sinceramente eres como mi mejor amigo jiji.\n\nEspero nunca te pegues el dedo chiquito del pie.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "De parte de Elizita monita muack";
